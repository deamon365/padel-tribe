                ...
                {terrainFeatures.map((feat) => (
                  <div key={feat.label} className="flex items-center gap-4">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-tribe-green/10">
                      <feat.icon className="h-5 w-5 text-tribe-green" />
                    </div>
                    <span className="text-sm text-tribe-black/70">
                      {feat.label}
                    </span>
                  </div>
                ))}
              </div>
              <div className="mt-8 rounded-xl bg-tribe-cream/50 p-4">
                <p className="text-xs font-medium uppercase tracking-wider text-tribe-gold">
                  Tribunes spectateurs
                </p>
                <p className="mt-1 text-sm text-tribe-black/60">
