        ...
        <div className="mx-auto max-w-3xl">
          <FadeIn>
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-tribe-black md:text-5xl">
              Comment tout
              <br />
              <span className="text-tribe-green">a commencé</span>
            </h2>
          </FadeIn>

          <FadeIn delay={0.1}>
            <div className="mt-10 space-y-6 text-base leading-relaxed text-tribe-black/70">
              <p>
              ...
              <p className="text-lg font-medium text-tribe-black">
